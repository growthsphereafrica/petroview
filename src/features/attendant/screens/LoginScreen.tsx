...
import { ArrowLeft, Flame, KeyRound, ShieldAlert, ShieldCheck, Sparkles, UserCheck, Zap } from 'lucide-react'
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-slate-300">Staff & Admin Access</span>
            </div>
            <button
